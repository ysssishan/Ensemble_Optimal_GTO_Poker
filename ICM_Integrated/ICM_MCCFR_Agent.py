...
# %%
class ICM_MCCFR_Agent():
    
    def __init__(self, env, model_path='./icm_mccfr_agent',
                 max_hands=100,
    ...
    def simulate_game(self, probs, player_id):
        ...
        if self.env.is_over():
            ...
            # Calculate the icm payoffs relative to the initial chipstack
            payoffs = end_icm - pre_icm
