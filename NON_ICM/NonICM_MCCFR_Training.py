...
from NonICM_MCCFR_Agent import NonICM_MCCFR_Agent
...
# Creat CFR Agent 
nonicm_mccfr_agent = NonICM_MCCFR_Agent(env,
...
# %%
with open('./nonicm_mccfr_agent/policy.pkl', 'rb') as f:
...
# %%
with open('./nonicm_mccfr_agent/regrets.pkl', 'rb') as f:
...
# %%
with open('./nonicm_mccfr_agent/average_policy.pkl', 'rb') as f:
