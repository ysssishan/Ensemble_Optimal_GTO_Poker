...
# %%
with open('./nonicm_ta_mccfr_agent/policy.pkl', 'rb') as f:
...
# %%
with open('./nonicm_ta_mccfr_agent/regrets.pkl', 'rb') as f:
...
# %%
with open('./nonicm_ta_mccfr_agent/average_policy.pkl', 'rb') as f:
