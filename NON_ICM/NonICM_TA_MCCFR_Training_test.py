...
from NonICM_TA_MCCFR_Agent_test import NonICM_TA_MCCFR_Agent_test
...
# Creat CFR Agent 
nonicm_ta_mccfr_agent_test = NonICM_TA_MCCFR_Agent_test(env, init_chipstack_pair=np.array([1000.0, 1000.0]),small_blind_multiplier=2)

# Train CFR Agent
num_iterations = 100000
train(nonicm_ta_mccfr_agent_test, num_iterations)

# Save
nonicm_ta_mccfr_agent_test.save()
...
# %%
with open('./nonicm_ta_mccfr_agent_test/policy.pkl', 'rb') as f:
...
# %%
with open('./nonicm_ta_mccfr_agent_test/regrets.pkl', 'rb') as f:
...
# %%
with open('./nonicm_ta_mccfr_agent_test/average_policy.pkl', 'rb') as f:
